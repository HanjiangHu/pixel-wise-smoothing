from archs_denoise import *
from archs_denoise.dncnn import DnCNN
from archs_denoise.cifar_resnet import resnet as resnet_cifar
from archs_denoise.memnet import MemNet
from archs_denoise.wrn import WideResNet
from datasets_denoise import get_normalize_layer
...
def get_architecture_denoise(arch: str, dataset: str, pytorch_pretrained: bool=False) -> torch.nn.Module:
