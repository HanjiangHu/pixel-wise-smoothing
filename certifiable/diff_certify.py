...
if __name__ == '__main__':
    ...
    smoothed_classifier = SemanticSmooth(base_classifier, get_num_classes(args.dataset), transformer, diff=True)
    ...
    for i in range(len(dataset)):
        ...
        before_time = time()
        img = diff_projection.projection_adder.proc(x, 0).cuda()
